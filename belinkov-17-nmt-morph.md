...
* we reveal interesting insights such as:
  ...
  * The target language impacts the kind of information learned by the system
    * Translating into morphologically-**poorer** languages leads to better
      source-side word representations
    * partly, but not completely, correlated with BLEU scores
  * The NMT encoder and decoder learn representations of similar quality
...
* not improve much: conjunctions, determiners, and particles (CC, DT, WP)
