...
| Dataset            | Granularity  | Annotation  | Size   | Topic          | Source               | License |
|--------------------|--------------|-------------|--------|----------------|----------------------|---------|
...
| DailyDialogs       | dialogues    | E           | 13,118 | multiple       | Li+ (2017)           | D-RO    |
...
| Emotion-Stimulus   | sentences    | E + shame   |  2,414 | general        | Ghazi+ (2015)        | D-U     |
| fb-valence-arousal | faceb. posts | V+A         |  2,895 | questionnaire  | Preoţiuc (2016)      | D-U     |
| Grounded-Emotions  | tweets       | HS          |  2,585 | weather/events | Liu+ (2017)          | D-U     |
| ISEAR              | descriptions | E + SG      |  7,665 | events         | Scherer (1994)       | GPLv3   |
| Tales              | sentences    | E           | 15,302 | fairytales     | Alm+ (2005)          | GPLv3   |
| SSEC               | tweets       | P           |  4,868 | general        | Schuff+ (2017)       | D-RO    |
