...
* new SOTA verb classification performance across all six target languages
...
* results indicate that
  ...
  * by propagating the VerbNet-style information from English
    ...
    * new SOTA verb classification performance for all six languages
...
* SOTA specialisation model termed PARAGRAM (Wieting+ 2015)
