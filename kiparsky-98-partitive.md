...
* two types of case, STRUCTURAL and INHERENT (or LEXICAL ) case (Chomsky 1981),
  ...
  * not all cases fall cleanly into this typology
  * a class of cases that pattern syntactically with the structural cases, but
    are semantically conditioned
    * depend on different semantic conditions than inherent cases do
    * inherent is sensitive to the thematic relation that the NP bears
    * hybrid sensitive to the NP’s definiteness, animacy, or quantificational
    ...
    * The Finnish partitive is a particularly clear instance of this apparently
      hybrid category of semantically conditioned structural case
* two functions of partitive
  * aspectual function: assigned to the objects of verbs which denote an
    unbounded event, in a sense to be made clear below
  * NP-related function: partitive case is assigned to quantitatively indetermi-
    ...
    even if the verb denotes a bounded event
