...
* Interpretability methods aim to
  ...
  by examining various aspects of the model,
  eg the weight matrices or the attention patterns
* we: a combination of
  theoretical results and carefully controlled experiments on synthetic data
