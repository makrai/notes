...
* retrofitting
  * vectors are refined to satisfy constraints extracted from a lexicons
...
* downstream application
  ...
  * multilingual spirit: we produce new Italian and German DST datasets and
    * Attract-Repel-specialised vectors leads to even stronger gains in these
  * single model that performs DST in all three languages,
    in each case outperforming the monolingual model
...
* two categories:
  ...
  * both categories make use of similar lexical resources
    * WordNet (Miller, 1995), FrameNet (Baker+ 1998) or the
      Paraphrase Databases (PPDB, Ganitkevitch+ 2013;
      Ganitkevitch and Callison-Burch, 2014; Pavlick+ 2015)
...
* Schwartz+ (2015) use symmetric patterns (Davidov and Rappoport, 2006) to
  push away antonymous words in their pattern-based vector space
...
* we show that Attract-Repel sets the new SOTA performance on SimLex-999 w sim
  * different languages in a unified vector space which
    benefits from positive semantic transfer

### Cross-Lingual Word Representations

* rely on cross-lingual distributional information
  (Klementiev+ 2012; Zou+ 2013; Soyer+ 2015; Huang+ 2015)
* differ in the cross-lingual signal/supervision they use
  * word-aligned data (Luong+ 2015; Coulmance+ 2015) or
  * sentence-aligned data (Hermann and Blunsom, 2014a; Hermann and Blunsom,
    2014b; Chandar+ 2014; Gouws+ 2015)
  * document-aligned data (Søgaard+ 2015; Vulić and Moens, 2016)
...
* shared cross-lingual vector spaces which can:
  * boost performance on monolingual tasks such as word similarity
    (Faruqui and Dyer, 2014; Rastogi+ 2015; Upadhyay+ 2016)
...
* prior work on cross-lingual word embedding didn't exploit linguistic resources
...
* Leviant and Reichart (2015) translated SimLex999 to German, Italian and Russan
  crowd-sourcing the similarity scores from native speakers
* we: same experimental setup to collect SimLex999 for Hebrew and Croatian
