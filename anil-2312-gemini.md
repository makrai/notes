...
* Gemini 1.0, our first version, comes in three sizes:
  ...
  * We evaluate the performance of Gemini models
    on a comprehensive suite of internal and external benchmarks covering
    a wide range of language, coding, reasoning, and multimodal tasks
* The AlphaCode team built AlphaCode 2 (Leblond+ 2023),
  ...
  with search and tool-use to excel at solving competitive programming problems
  * AlphaCode 2 ranks within the top 15% of entrants on the Codeforces
    competitive programming platform,
    a large improvement over its SOTA predecessor in the top 50% (Li+ 2022)
* Gemini Nano, a series of small models targeting on-device deployment
...
* MMLU has been a defacto measure of progress for LLMs ever since it was first
  released in 2020
* multimodal domain, 
  * Gemini Ultra sets new SOTA on most of the image, video, and audio understand
    benchmarks without task-specific modifications or tuning
  * Gemini Ultra has SOTA performance on the recent MMMU benchmark (Yue+ 2023),
    * MMMU comprises questions about images requiring
      college-level subject knowledge and deliberate reasoning
* new use cases enabled by Gemini models
  * eg
  ...
  * can enable new approaches in eg education, everyday problem solving,
    ...
    creativity. The users of these models will find all kinds
* limitations to the use of LLMs
  ...
  * ? high-level reasoning abilities like causal understanding,
    ...
    * need for more challenging and robust evaluations to measure their truth
