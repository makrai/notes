...
* two outcomes of the project: an
  ...
  * online database ValPaL,
    * by Iren Hartmann, Martin Haspelmath, & Bradley Taylor)
  * Both are based on a database questionnaire for a
    * selected sample of 80 verbs
* rigorous review, and the revised version differs substantially

# 1 Introduction

* organized as follows.
  2. the general characteristics of Italian morphosyntax.
  3. the major valency patterns of Italian
  4. argument encoding
...
## 3.2 Avalent verbs (coding frame: ((S) > V.subj3SG/S)

* metereological phenomena  and astronomical events

## 3.3 Monovalent verbs (coding frame: `<S>V.subjS`)
...
## 3.5 Trivalent verbs (coding frame: `A > V.subjA > T (a+R) (L) (I) (di+X)`)
