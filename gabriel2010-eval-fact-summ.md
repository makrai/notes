...
* five necessary and intuitive conditions to evaluate factuality metrics
  on diagnostic factuality data across three different summarization tasks
...
* Commonly used metrics
  ...
  * poorly correlate with human judgements
    (Hashimoto+ 2019; Clark+ 2019; Sellam+ 2020), leading to a rapidly
...
* contributions
  ...
  * an evaluation dataset of summaries generated by transformer-based models
    (Raffel+ 2019 T5) annotated with types of factual errors
...
* robustness and generality (Conditions III and IV) by separately running this
...
* recently proposed metrics which use two types of proxy NLU objectives aimed at
  implicitly capturing factuality in generated text. 
...
* metrics displaying invalid behavior on controlled data also do so in model gen
  ...
  * follows our intuition that
    non-entity errors are difficult for standard summarization metrics
    * non-entity errors are frequently produced by abstractive summ models
...
* question-answering objective is promising for measuring factual consistency
  across domains, but effectiveness depends on the question. QA metrics
...
We inject errors into reference summaries by first
  * using a part-of-speech tagging model and named entity recognition (spaCy) to
...
* Pronoun entity errors with a preset list of commonly used pronouns. We
  * we swap e.g. she/her with he/him
