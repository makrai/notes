...
* word analogy task (Mikolov+ 2013b)
  ...
  * the vector offset method is underestimating the amount of semantic info
    captured by the embedding (Drozd+ 2016)
...
* eg two published modifications of the word2vec model, both trained on Wikiped
  ...
  * Table 1 lists the first 7 nearest neighbors of color (cosine similarity)
...
* Which of these models is “better”? Without the context of some application?
  ...
  * sequence labeling tasks:
    * relatedness tests were found to poorly correlate with performance on it
...
* This work explores 3 popular word embedding algorithms
  ...
  * The pre-trained vectors we used were published by Li+ (2017)
    ...
    * different vector sizes (25, 50, 100, 250, 500). In total, 60 models
...
* we also exclude the words belonging to several parts of speech (eg dog N, V)
  ...
  * discards a lot of high-frequency vocabulary => the higher frequency bins
    for verbs and adjectives were not populated fully
...
* analogy taskwe use BATS dataset (Gladkova+ 2016)
