...
* first two papers: a structural account of cognitive repr and problem solving
...
* We call the resulting architecture a medium solver
  ...
  * Its implementation (architecture) is replaceable
    * It may use deterministic graph navigation, a heuristic or learned policy,
      ...
      another functionally equivalent mechanism
